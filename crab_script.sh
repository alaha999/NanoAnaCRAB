...
#Source CMSSW environment (CRAB sets this up automatically)
#echo "Setting up CMSSW environment..."
#source /cvmfs/cms.cern.ch/cmsset_default.sh
#export SCRAM_ARCH=el8_amd64_gcc12
#eval `scramv1 runtime -sh`  # Use the existing CMSSW environment from CRAB

# Move to the CRAB working directory
#cd $CMSSW_BASE/src
